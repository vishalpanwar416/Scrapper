 ...
 */
export async function scrapeGeneric(websiteId, websiteUrl, progressCallback) {
    let browser = null;
    ...
    try {
        ...
        const pageProducts = await page.evaluate(() => {
            ...
            const strategies = [
                ...
                () => {
                    return Array.from(document.querySelectorAll('[class*="product"], [class*="item"], [class*="card"]'));
                },
                ...
                () => {
                    ...
                    return Array.from(main.querySelectorAll('li, div[class*="grid"]'));
                }
            ];
            let products = [];
            ...
            products.forEach((container) => {
                try {
                    ...
                    if (!href || href.startsWith('#') || href.includes('?sort'))
                        return;
                    // Deduplicate
