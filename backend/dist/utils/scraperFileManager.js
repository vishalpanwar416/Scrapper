...
class ScraperFileManager {
    constructor() {
        ...
        this.defaultScrapers = ['snitch', 'rarerabbit', 'offduety', 'zara', 'beyoung', 'generic'];
    }
    /**
     ...
     */
    async getScraperContent(websiteName) {
        try {
     ...
     */
    async updateScraperContent(websiteName, content) {
        try {
     ...
     */
    getScraperTemplate(websiteName, websiteUrl) {
