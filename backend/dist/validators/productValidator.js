...
export class ProductValidator {
     ...
     */
    static validateOriginalPrice(originalPrice, price) {
    ...
    static validateColors(colors) {
        ...
        colors.slice(0, rules.maxItems).forEach((color, index) => {
    ...
    static validateSizes(sizes) {
        ...
        sizes.slice(0, rules.maxItems).forEach((size, index) => {
     ...
     */
    static convertSizesFormat(sizes) {
...
ProductValidator.VALIDATION_RULES = {
    title: {
        minLength: 3,
        maxLength: 500,
        required: true,
